...
# ============================================================
# /agree - Ab reply user se target lega, user ID nahi
# ============================================================
...
async def agree_deal(client: Client, message: Message):
    ...
    # Target user ko reply se uthao
    if not message.reply_to_message or not message.reply_to_message.from_user:
        await message.reply("❌ Reply to the user's message you want to set as the agreement confirmer.")
        return
    ...
    # User ka naam mentionable link ke saath
...
# ============================================================
# /confirm - Ab reply user se target lega, user ID nahi
# ============================================================
...
async def confirm_deal(client: Client, message: Message):
    ...
    # Target user ko reply se uthao
    if not message.reply_to_message or not message.reply_to_message.from_user:
        await message.reply("❌ Reply to the user's message who should make the decision.")
        return
...
async def confirm_callback(client: Client, callback_query: CallbackQuery):
    ...
    if action == "release":
        ...
        await msg.reply(
            ...
            f"**Now, Wait @shuify Response as soon as possible.**"
        )
